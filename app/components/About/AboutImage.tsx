  ...
  return (
    <div className="relative h-full w-full flex justify-center mt-20 lg:mt-0 bg-white">
      ...
      <div className="absolute md:-top-16 md:-right-4 top-0 transform -translate-y-1/2 md:translate-y-0 w-full md:w-auto">
        <p className="shadow-lg flex items-center justify-center text-white text-2xl uppercase border-8 border-[#fff] rounded-2xl bg-[#9eaf2b] w-[300px] lg:w-[240px] h-[150px] mx-auto lg:mx-0">
          Fast Service
        </p>
      </div>
      <motion.div className="hidden md:block absolute -bottom-8 -left-4">
        <Image
          ...
          width={300}
          height={350}
          className="shadow-lg border-8 border-[#9eaf2b] rounded-tr-2xl rounded-tl-2xl"
        />
      </motion.div>
    </div>
  );
