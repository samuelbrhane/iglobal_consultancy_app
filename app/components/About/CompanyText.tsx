    ...
    <div className="relative">
      <div className="flex flex-col justify-center  w-full">
        <motion.h1
          ...
          className="text-2xl lg:text-4xl font-bold mb-4 lg:mb-6 mt-4 text-[#9eaf2b] -top-16 lg:absolute font-[Lora]"
        >
        ...
        >
          ...
          <CompanyCard
            ...
            subtitle="Comprehensive visa services for work and travel globally."
            icon={faGlobe}
          />
        </motion.div>
      </div>
